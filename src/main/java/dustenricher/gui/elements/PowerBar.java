...
public class PowerBar extends GuiElement{
	...
	public PowerBar(IGuiWrapper gui, DustInjectionChamberTE tile, ResourceLocation def, int x, int y)
	{
	...
	public PowerBar(IGuiWrapper gui, IPowerInfoHandler h, ResourceLocation def, int x, int y)
	{
		super(MekanismUtils.getResource(ResourceType.GUI_ELEMENT, "GuiPowerBar.png"), gui, def);
